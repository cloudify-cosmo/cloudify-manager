...
@celery.task
def deploy_application(application_name, application_code, **kwargs):
    ...
    with open(application_file, "w") as f: f.write(application_code)
...
if __name__ == "__main__":
    ...
    deploy_application(application_name, application_code)
