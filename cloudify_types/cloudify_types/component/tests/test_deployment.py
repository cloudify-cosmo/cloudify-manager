...
class TestDeployment(TestDeploymentBase):
    ...
    def test_delete_deployment_success(self):
        ...
        with mock.patch('cloudify.manager.get_rest_client') as mock_client:
            ...
            assert not cfy_mock_client.secrets.delete.called
            assert not cfy_mock_client.plugins.delete.called
    ...
    def test_create_deployment_failed(self):
        with mock.patch('cloudify.manager.get_rest_client') as mock_client:
            ...
            list_response = cfy_mock_client.executions.list()
            list_response[0]['id'] = 'exec_id'
            list_response[0]['workflow_id'] = 'test'
            list_response[0]['deployment_id'] = 's'
