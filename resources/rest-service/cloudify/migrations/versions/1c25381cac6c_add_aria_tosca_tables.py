...
def upgrade():
    ...
    op.create_table('tosca_service_update_step',
        sa.Column('id', sa.INTEGER(), nullable=False),
        sa.Column('name', sa.TEXT(), autoincrement=False, nullable=True),
        sa.Column('action', postgresql.ENUM(u'add', u'remove', u'modify', name='action_type'), autoincrement=False, nullable=False),
        sa.Column('entity_id', sa.TEXT(), autoincrement=False, nullable=False),
        sa.Column('entity_type', postgresql.ENUM(u'node', u'relationship', u'property', u'operation', u'workflow', u'output', u'description', u'group', u'policy_type', u'policy_trigger', u'plugin', name='entity_type'), autoincrement=False, nullable=False),
    ...
    op.create_table('tosca_task',
        ...
        sa.Column('name', sa.TEXT(), autoincrement=False, nullable=True),
        sa.Column('status', postgresql.ENUM(u'pending', u'retrying', u'sent', u'started', u'success', u'failed', name='status'), autoincrement=False, nullable=True),
        ...
        sa.Column('_stub_type', postgresql.ENUM(u'start_workflow', u'start_subworkflow', u'end_workflow', u'end_subworkflow', u'stub', u'conditional', name='stub_type'), autoincrement=False, nullable=True),
        sa.Column('plugin_fk', sa.INTEGER(), autoincrement=False, nullable=True),
        sa.Column('execution_fk', sa.INTEGER(), autoincrement=False, nullable=True),
        sa.Column('relationship_fk', sa.INTEGER(), autoincrement=False, nullable=True),
        sa.Column('node_fk', sa.INTEGER(), autoincrement=False, nullable=True),
    ...
    op.create_table('tosca_node',
        ...
        sa.Column('name', sa.TEXT(), autoincrement=False, nullable=True),
        sa.Column('description', sa.TEXT(), autoincrement=False, nullable=True),
        sa.Column('state', postgresql.ENUM(u'initial', u'creating', u'created', u'configuring', u'configured', u'starting', u'started', u'stopping', u'deleting', u'deleted', u'error', name='node_state'), autoincrement=False, nullable=False),
    ...
    op.create_table('tosca_execution',
        ...
        sa.Column('status', postgresql.ENUM(u'terminated', u'failed', u'cancelled', u'pending', u'started', u'cancelling', u'force_cancelling', name='execution_status'), autoincrement=False, nullable=True),
    ...
    op.create_table('tosca_service_modification',
        ...
        sa.Column('status', postgresql.ENUM(u'started', u'finished', u'rolledback', name='service_modification_status'), autoincrement=False, nullable=True),
        sa.Column('service_fk', sa.INTEGER(), autoincrement=False, nullable=False),
...
def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_table('tosca_policy_template_node_template')
    op.drop_table('tosca_valid_sources_capability_template_type')
    op.drop_table('tosca_policy_group')
    op.drop_table('tosca_service_metadata')
    op.drop_table('tosca_policy_template_group_template')
    op.drop_table('tosca_operation')
    op.drop_table('tosca_argument')
    op.drop_table('tosca_node_template')
    op.drop_table('tosca_service_modification')
    op.drop_table('tosca_log')
    op.drop_table('tosca_execution')
    op.drop_table('tosca_node')
    op.drop_table('tosca_capability_template')
    op.drop_table('tosca_input')
    op.drop_table('tosca_policy_template')
    op.drop_table('tosca_type')
    op.drop_table('tosca_service_plugin')
    op.drop_table('tosca_artifact_template')
    op.drop_table('tosca_group')
    op.drop_table('tosca_relationship')
    op.drop_table('tosca_relationship_template')
    op.drop_table('tosca_substitution_template_mapping')
    op.drop_table('tosca_service_template_metadata')
    op.drop_table('tosca_capability')
    op.drop_table('tosca_metadata')
    op.drop_table('tosca_policy')
    op.drop_table('tosca_task_task')
    op.drop_table('tosca_output')
    op.drop_table('tosca_plugin')
    op.drop_table('tosca_operation_template')
    op.drop_table('tosca_interface_template')
    op.drop_table('tosca_interface')
    op.drop_table('tosca_substitution')
    op.drop_table('tosca_group_template_node_template')
    op.drop_table('tosca_task')
    op.drop_table('tosca_requirement_template')
    op.drop_table('tosca_service_update')
    op.drop_table('tosca_substitution_template')
    op.drop_table('tosca_attribute')
    op.drop_table('tosca_group_template')
    op.drop_table('tosca_group_node')
    op.drop_table('tosca_artifact')
    op.drop_table('tosca_service')
    op.drop_table('tosca_property')
    op.drop_table('tosca_service_template')
    op.drop_table('tosca_service_update_step')
    op.drop_table('tosca_substitution_mapping')
    op.drop_table('tosca_plugin_specification')
    op.drop_table('tosca_configuration')
    op.drop_table('tosca_policy_node')
    # ### end Alembic commands ###
