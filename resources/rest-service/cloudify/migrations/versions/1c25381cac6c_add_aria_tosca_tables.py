...
def upgrade():
    ...
    op.create_table('tosca_node',
        ...
        sa.Column('name', sa.TEXT(), autoincrement=False, nullable=True),
        sa.Column('description', sa.TEXT(), autoincrement=False, nullable=True),
        sa.Column('state', postgresql.ENUM(u'initial', u'creating', u'created', u'configuring', u'configured', u'starting', u'started', u'stopping', u'deleting', u'deleted', u'error', name='tosca_node_state'), autoincrement=False, nullable=False),
    ...
    op.create_table('tosca_execution',
        ...
        sa.Column('status', postgresql.ENUM(u'terminated', u'failed', u'cancelled', u'pending', u'started', u'cancelling', u'force_cancelling', name='tosca_execution_status'), autoincrement=False, nullable=True),
    ...
    op.create_table('tosca_service_update_step',
        sa.Column('id', sa.INTEGER(), nullable=False),
        sa.Column('name', sa.TEXT(), autoincrement=False, nullable=True),
        sa.Column('action', postgresql.ENUM(u'add', u'remove', u'modify', name='tosca_action_type'), autoincrement=False, nullable=False),
        sa.Column('entity_id', sa.TEXT(), autoincrement=False, nullable=False),
        sa.Column('entity_type', postgresql.ENUM(u'node', u'relationship', u'property', u'operation', u'workflow', u'output', u'description', u'group', u'policy_type', u'policy_trigger', u'plugin', name='tosca_entity_type'), autoincrement=False, nullable=False),
    ...
    op.create_table('tosca_task',
        ...
        sa.Column('name', sa.TEXT(), autoincrement=False, nullable=True),
        sa.Column('status', postgresql.ENUM(u'pending', u'retrying', u'sent', u'started', u'success', u'failed', name='tosca_status'), autoincrement=False, nullable=True),
        ...
        sa.Column('_stub_type', postgresql.ENUM(u'start_workflow', u'start_subworkflow', u'end_workflow', u'end_subworkflow', u'stub', u'conditional', name='tosca_stub_type'), autoincrement=False, nullable=True),
        sa.Column('plugin_fk', sa.INTEGER(), autoincrement=False, nullable=True),
        sa.Column('execution_fk', sa.INTEGER(), autoincrement=False, nullable=True),
        sa.Column('relationship_fk', sa.INTEGER(), autoincrement=False, nullable=True),
        sa.Column('node_fk', sa.INTEGER(), autoincrement=False, nullable=True),
    ...
    op.create_table('tosca_service_modification',
        ...
        sa.Column('status', postgresql.ENUM(u'started', u'finished', u'rolledback', name='tosca_service_modification_status'), autoincrement=False, nullable=True),
        sa.Column('service_fk', sa.INTEGER(), autoincrement=False, nullable=False),
