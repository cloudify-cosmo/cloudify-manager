...
def upgrade():
    ...
    op.create_foreign_key(op.f('deployment_modifications__tenant_id_fkey'), 'deployment_modifications', 'tenants', ['_tenant_id'], ['id'], ondelete='CASCADE')
    op.create_foreign_key(op.f('deployment_modifications__creator_id_fkey'), 'deployment_modifications', 'users', ['_creator_id'], ['id'], ondelete='CASCADE')
    ...
    op.create_foreign_key(op.f('deployment_update_steps__tenant_id_fkey'), 'deployment_update_steps', 'tenants', ['_tenant_id'], ['id'], ondelete='CASCADE')
    op.create_foreign_key(op.f('deployment_update_steps__creator_id_fkey'), 'deployment_update_steps', 'users', ['_creator_id'], ['id'], ondelete='CASCADE')
    ...
    op.create_foreign_key(op.f('deployment_updates__creator_id_fkey'), 'deployment_updates', 'users', ['_creator_id'], ['id'], ondelete='CASCADE')
    op.create_foreign_key(op.f('deployment_updates__tenant_id_fkey'), 'deployment_updates', 'tenants', ['_tenant_id'], ['id'], ondelete='CASCADE')
    ...
    op.create_foreign_key(op.f('deployments__tenant_id_fkey'), 'deployments', 'tenants', ['_tenant_id'], ['id'], ondelete='CASCADE')
    ...
    op.create_foreign_key(op.f('events__tenant_id_fkey'), 'events', 'tenants', ['_tenant_id'], ['id'], ondelete='CASCADE')
    op.create_foreign_key(op.f('events__creator_id_fkey'), 'events', 'users', ['_creator_id'], ['id'], ondelete='CASCADE')
    ...
    op.create_foreign_key(op.f('logs__tenant_id_fkey'), 'logs', 'tenants', ['_tenant_id'], ['id'], ondelete='CASCADE')
    op.create_foreign_key(op.f('logs__creator_id_fkey'), 'logs', 'users', ['_creator_id'], ['id'], ondelete='CASCADE')
    ...
    op.create_foreign_key(op.f('node_instances__creator_id_fkey'), 'node_instances', 'users', ['_creator_id'], ['id'], ondelete='CASCADE')
    op.create_foreign_key(op.f('node_instances__tenant_id_fkey'), 'node_instances', 'tenants', ['_tenant_id'], ['id'], ondelete='CASCADE')
    ...
    op.create_foreign_key(op.f('nodes__tenant_id_fkey'), 'nodes', 'tenants', ['_tenant_id'], ['id'], ondelete='CASCADE')
    op.create_foreign_key(op.f('nodes__creator_id_fkey'), 'nodes', 'users', ['_creator_id'], ['id'], ondelete='CASCADE')
...
def downgrade():
    ...
    op.drop_constraint(op.f('nodes__creator_id_fkey'), 'nodes', type_='foreignkey')
    op.drop_constraint(op.f('nodes__tenant_id_fkey'), 'nodes', type_='foreignkey')
    ...
    op.drop_constraint(op.f('node_instances__tenant_id_fkey'), 'node_instances', type_='foreignkey')
    op.drop_constraint(op.f('node_instances__creator_id_fkey'), 'node_instances', type_='foreignkey')
    ...
    op.drop_constraint(op.f('logs__creator_id_fkey'), 'logs', type_='foreignkey')
    op.drop_constraint(op.f('logs__tenant_id_fkey'), 'logs', type_='foreignkey')
    ...
    op.drop_constraint(op.f('events__creator_id_fkey'), 'events', type_='foreignkey')
    op.drop_constraint(op.f('events__tenant_id_fkey'), 'events', type_='foreignkey')
    ...
    op.drop_constraint(op.f('deployments__tenant_id_fkey'), 'deployments', type_='foreignkey')
    ...
    op.drop_constraint(op.f('deployment_updates__tenant_id_fkey'), 'deployment_updates', type_='foreignkey')
    op.drop_constraint(op.f('deployment_updates__creator_id_fkey'), 'deployment_updates', type_='foreignkey')
    ...
    op.drop_constraint(op.f('deployment_update_steps__creator_id_fkey'), 'deployment_update_steps', type_='foreignkey')
    op.drop_constraint(op.f('deployment_update_steps__tenant_id_fkey'), 'deployment_update_steps', type_='foreignkey')
    ...
    op.drop_constraint(op.f('deployment_modifications__creator_id_fkey'), 'deployment_modifications', type_='foreignkey')
    op.drop_constraint(op.f('deployment_modifications__tenant_id_fkey'), 'deployment_modifications', type_='foreignkey')
