...
def upgrade():
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ['_creator_id'], [u'users.id'], ondelete='CASCADE'),
        sa.ForeignKeyConstraint(
            ['_tenant_id'], [u'tenants.id'], ondelete='CASCADE'),
    ...
    op.create_index(
        op.f('ix_blueprints_id'), 'blueprints', ['id'], unique=False)
    op.create_table(
        'groups_tenants',
    ...
    op.create_index(
        op.f('ix_plugins_id'), 'plugins', ['id'], unique=False)
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column('user_id', sa.Integer(), nullable=True),
        sa.ForeignKeyConstraint(
            ['blueprint_id'], ['blueprints._storage_id'], ),
        sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
    )
    op.create_table(
    ...
    op.create_table(
        ...
        sa.Column(
            'is_system_workflow',
            sa.Boolean(name='is_system_workflow'),
            nullable=False,
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            'deployment_update_deployment', sa.PickleType(), nullable=True),
    ...
    op.create_index(
        op.f('ix_logs_timestamp'), 'logs', ['timestamp'], unique=False)
    op.create_table(
        'node_instances',
        sa.Column('_storage_id', sa.Integer(), nullable=False),
        sa.Column('id', sa.Text(), nullable=True),
        ...
        sa.ForeignKeyConstraint(
            ['_node_fk'], [u'nodes._storage_id'], ondelete='CASCADE'),
        sa.PrimaryKeyConstraint('_storage_id'),
    )
    op.create_index(
        op.f('ix_node_instances_id'), 'node_instances', ['id'], unique=False)
    op.create_table(
