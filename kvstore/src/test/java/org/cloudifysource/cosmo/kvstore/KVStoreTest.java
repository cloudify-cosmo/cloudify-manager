...
/**
 * Unit tests for {@link KVStoreServer} and {@link KVStoreServlet}.
 *
 * @author itaif
 * @since 0.1
 */
public class KVStoreTest {
    ...
    public void helloEtag() {
        ClientResponse putResponse =
                webResource.path("test").header("If-None-Match", "*").put(ClientResponse.class, "1");
    ...
    public void helloWrongIfMatchEtag() {
        ...
        ClientResponse putResponse =
                webResource.path("test").header("If-Match", wrongEtag).put(ClientResponse.class, "2");
    ...
    public void helloWrongIfMatchEtagWhenEmpty() {
        final EntityTag wrongEtag = KVEntityTag.create("0");
        ClientResponse putResponse =
                webResource.path("test").header("If-Match", wrongEtag).put(ClientResponse.class, "1");
        Assert.assertEquals(putResponse.getStatus(), ClientResponse.Status.PRECONDITION_FAILED.getStatusCode());
