...
class ResourceManager(object):
    ...
    def _create_deployment_nodes(self,
        ...
        nodes, relationships = self.prepare_deployment_nodes_for_storage(plan, deployment, node_ids)
    ...
    def add_node_instance_from_dict(self, instance_dicts):
        ...
        for instance_dict in instance_dicts:
            ...
            new_node_instance = models.NodeInstance(host=hosts[0] if hosts else None,
                                                    **instance_dict)
