 ...
 * @since 0.1
 */
public class DeprecatedStateCacheTest {

    private DeprecatedStateCache stateCache;

    @BeforeMethod
    public void before() {
        stateCache = new DeprecatedStateCache.Builder()
                .build();
    }
    ...
    public void testInitialState() {
        ...
        String key = "key";
        Object value = "value";
        stateCache = new DeprecatedStateCache.Builder().initialState(ImmutableMap.<String, Object>builder().put(key,
                value).build()).build();
    ...
    public void testWaitForKeyValueState() throws InterruptedException {
        ...
        stateCache.subscribeToKeyValueStateChanges(reciever, context, key, new StateChangeCallback() {
            public boolean onStateChange(Object receiverParam, Object contextParam, DeprecatedStateCache cache,
