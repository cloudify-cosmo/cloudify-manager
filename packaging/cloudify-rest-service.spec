...
Source0:  http://www.getcloudify.org/spec/diamond-plugin/1.3.8/plugin.yaml
...
/opt/manager/env/bin/pip install 'git+https://github.com/cloudify-cosmo/cloudify-dsl-parser@4.3.1-build#egg=cloudify-dsl-parser==4.3.1'
