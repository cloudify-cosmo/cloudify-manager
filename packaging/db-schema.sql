...
-- Running upgrade 272e61bf5f4a -> edd6d829a209

ALTER TABLE blueprints RENAME plan TO plan_p;

ALTER TABLE deployments RENAME inputs TO inputs_p;

ALTER TABLE deployments RENAME groups TO groups_p;

ALTER TABLE deployments RENAME policy_triggers TO policy_triggers_p;

ALTER TABLE deployments RENAME policy_types TO policy_types_p;

ALTER TABLE deployments RENAME outputs TO outputs_p;

ALTER TABLE deployments RENAME capabilities TO capabilities_p;

ALTER TABLE deployments RENAME scaling_groups TO scaling_groups_p;

ALTER TABLE deployments RENAME workflows TO workflows_p;

ALTER TABLE deployment_modifications RENAME context TO context_p;

ALTER TABLE deployment_modifications RENAME modified_nodes TO modified_nodes_p;

ALTER TABLE deployment_modifications RENAME node_instances TO node_instances_p;

ALTER TABLE deployment_updates RENAME deployment_plan TO deployment_plan_p;

ALTER TABLE deployment_updates RENAME deployment_update_node_instances TO deployment_update_node_instances_p;

ALTER TABLE deployment_updates RENAME deployment_update_deployment TO deployment_update_deployment_p;

ALTER TABLE deployment_updates RENAME central_plugins_to_uninstall TO central_plugins_to_uninstall_p;

ALTER TABLE deployment_updates RENAME central_plugins_to_install TO central_plugins_to_install_p;

ALTER TABLE deployment_updates RENAME deployment_update_nodes TO deployment_update_nodes_p;

ALTER TABLE deployment_updates RENAME modified_entity_ids TO modified_entity_ids_p;

ALTER TABLE deployment_updates RENAME old_inputs TO old_inputs_p;

ALTER TABLE deployment_updates RENAME new_inputs TO new_inputs_p;

ALTER TABLE executions RENAME parameters TO parameters_p;

ALTER TABLE nodes RENAME plugins TO plugins_p;

ALTER TABLE nodes RENAME plugins_to_install TO plugins_to_install_p;

ALTER TABLE nodes RENAME properties TO properties_p;

ALTER TABLE nodes RENAME relationships TO relationships_p;

ALTER TABLE nodes RENAME operations TO operations_p;

ALTER TABLE nodes RENAME type_hierarchy TO type_hierarchy_p;

ALTER TABLE node_instances RENAME relationships TO relationships_p;

ALTER TABLE node_instances RENAME runtime_properties TO runtime_properties_p;

ALTER TABLE node_instances RENAME scaling_groups TO scaling_groups_p;

ALTER TABLE plugins RENAME excluded_wheels TO excluded_wheels_p;

ALTER TABLE plugins RENAME supported_platform TO supported_platform_p;

ALTER TABLE plugins RENAME supported_py_versions TO supported_py_versions_p;

ALTER TABLE plugins ALTER COLUMN wheels DROP NOT NULL;

ALTER TABLE plugins RENAME wheels TO wheels_p;

ALTER TABLE plugins_updates RENAME deployments_to_update TO deployments_to_update_p;

ALTER TABLE blueprints ADD COLUMN plan TEXT;

ALTER TABLE deployments ADD COLUMN inputs TEXT;

ALTER TABLE deployments ADD COLUMN groups TEXT;

ALTER TABLE deployments ADD COLUMN policy_triggers TEXT;

ALTER TABLE deployments ADD COLUMN policy_types TEXT;

ALTER TABLE deployments ADD COLUMN outputs TEXT;

ALTER TABLE deployments ADD COLUMN capabilities TEXT;

ALTER TABLE deployments ADD COLUMN scaling_groups TEXT;

ALTER TABLE deployments ADD COLUMN workflows TEXT;

ALTER TABLE deployment_modifications ADD COLUMN context TEXT;

ALTER TABLE deployment_modifications ADD COLUMN modified_nodes TEXT;

ALTER TABLE deployment_modifications ADD COLUMN node_instances TEXT;

ALTER TABLE deployment_updates ADD COLUMN deployment_plan TEXT;

ALTER TABLE deployment_updates ADD COLUMN deployment_update_node_instances TEXT;

ALTER TABLE deployment_updates ADD COLUMN deployment_update_deployment TEXT;

ALTER TABLE deployment_updates ADD COLUMN central_plugins_to_uninstall TEXT;

ALTER TABLE deployment_updates ADD COLUMN central_plugins_to_install TEXT;

ALTER TABLE deployment_updates ADD COLUMN deployment_update_nodes TEXT;

ALTER TABLE deployment_updates ADD COLUMN modified_entity_ids TEXT;

ALTER TABLE deployment_updates ADD COLUMN old_inputs TEXT;

ALTER TABLE deployment_updates ADD COLUMN new_inputs TEXT;

ALTER TABLE executions ADD COLUMN parameters TEXT;

ALTER TABLE nodes ADD COLUMN plugins TEXT;

ALTER TABLE nodes ADD COLUMN plugins_to_install TEXT;

ALTER TABLE nodes ADD COLUMN properties TEXT;

ALTER TABLE nodes ADD COLUMN relationships TEXT;

ALTER TABLE nodes ADD COLUMN operations TEXT;

ALTER TABLE nodes ADD COLUMN type_hierarchy TEXT;

ALTER TABLE node_instances ADD COLUMN relationships TEXT;

ALTER TABLE node_instances ADD COLUMN runtime_properties TEXT;

ALTER TABLE node_instances ADD COLUMN scaling_groups TEXT;

ALTER TABLE plugins ADD COLUMN excluded_wheels TEXT;

ALTER TABLE plugins ADD COLUMN supported_platform TEXT;

ALTER TABLE plugins ADD COLUMN supported_py_versions TEXT;

ALTER TABLE plugins ADD COLUMN wheels TEXT NOT NULL;

ALTER TABLE plugins_updates ADD COLUMN deployments_to_update TEXT;

UPDATE alembic_version SET version_num='edd6d829a209' WHERE alembic_version.version_num = '272e61bf5f4a';
