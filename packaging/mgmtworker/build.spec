...
curl --retry 10 --fail --silent --show-error --location https://github.com/cloudify-cosmo/cloudify-manager/archive/CFY-4287-unblock-botched-deployment.tar.gz --create-dirs --output $destination && \
