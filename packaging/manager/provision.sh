...
curl -u $GITHUB_USERNAME:$GITHUB_PASSWORD https://raw.githubusercontent.com/cloudify-cosmo/${REPO}/CFY-7289-Add-Stage-to-community-edition/packages-urls/common_build_env.sh -o ./common_build_env.sh &&
